    ...
    <div>
      ...
      <table id="expandtable">
        <tr>
          ...
          <td><input type="number" step=".01" name="1st" id="1st" value="<?php $one = $_GET["1st"]; echo $one; ?>"></td>
        </tr>
        <tr>
          <td>2nd spell cost:</td>
          <td><input type="number" step=".01" name="2nd" id="2nd" value="<?php $two = $_GET["2nd"]; echo $two; ?>"></td>
        </tr>
        <tr>
          <td>3rd spell cost:</td>
          <td><input type="number" step=".01" name="3rd" id="3rd" value="<?php $three = $_GET["3rd"]; echo $three; ?>"></td>
        </tr>
        <tr>
          <td>4th spell cost:</td>
          <td><input type="number" step=".01" name="4th" id="4th" value="<?php $four = $_GET["4th"]; echo $four; ?>"></td>
        </tr>
      </table><br></div>
    <div>
      <h3>Cycle:</h3>
...
<div class="credits">Made by 1ngo. with help from phantamanta44</div>
</body>
</html>
